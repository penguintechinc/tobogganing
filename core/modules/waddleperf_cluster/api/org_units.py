...
from core.modules.waddleperf_cluster.services.org_unit_manager import OrgUnitManager
...
@require_feature("waddleperf_cluster", "org_units")
async def create_org_unit() -> tuple[dict[str, Any], int]:
    """Create a new organizational unit.

    Required scope: org_units:write
    Required feature: waddleperf_cluster.org_units
