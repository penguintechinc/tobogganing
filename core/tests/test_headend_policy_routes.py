...
async def test_get_firewall_rules_success(app_with_sase: Quart) -> None:
    ...
    with patch("core.api.headend_routes.get_access_control_manager") as mock_get_acm:
        mock_acm = AsyncMock()
        ...
        with patch("core.api.headend_routes.get_user_manager") as mock_get_um:
            mock_um = AsyncMock()
...
async def test_get_headend_ports_success(app_with_sase: Quart) -> None:
    ...
    with patch("core.api.headend_routes.get_port_config_manager") as mock_get_pcm:
        mock_pcm = AsyncMock()
...
async def test_get_headend_ports_tenant_param_ignored(app_with_sase: Quart) -> None:
    ...
    with patch("core.api.headend_routes.get_port_config_manager") as mock_get_pcm:
        ...
        with patch("core.api.headend_routes.get_db") as mock_get_db:
