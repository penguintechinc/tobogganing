...
def module() -> ModuleContract:
    ...
    """
    # Combine existing blueprints with blocklist, SWG, and blockpages blueprints
    all_blueprints = list(blueprints) + [blocklist_blueprint, swg_blueprint, blockpages_blueprint]
