"""Celery application for SWG Tier-2 AI categorizer worker.

Provides a Celery instance for background task execution.
"""
...
celery_app.conf.update(
    ...
    task_default_queue="tobogganing_swg",
