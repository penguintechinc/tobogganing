...
from hub_api.modules.waddleperf_c2c.api import blueprints
...
def module() -> ModuleContract:
    ...
    register_job_handler(
        "waddleperf_c2c",
        "matrix_run",
        "hub_api.modules.waddleperf_c2c.worker.tasks.start_recurring_run",
    )
    register_job_handler(
        "waddleperf_c2c",
        "node_health",
        "hub_api.modules.waddleperf_c2c.worker.tasks.node_health",
    )
