...
def module() -> ModuleContract:
    ...
    return ModuleContract(
        ...
        flags=[
            "tobogganing.perftest_c2c.endpoints",
            "tobogganing.perftest_c2c.runs",
            "tobogganing.perftest_c2c.matrix",
            "tobogganing.perftest_c2c.recurring_runs",
            "tobogganing.perftest_c2c.regions",
        ],
        entitlements=[
            Entitlement("perftest_c2c.endpoints", "professional"),
            Entitlement("perftest_c2c.runs", "professional"),
            Entitlement("perftest_c2c.matrix", "professional"),
            Entitlement("perftest_c2c.recurring_runs", "professional"),
            Entitlement("perftest_c2c.regions", "professional"),
        ],
