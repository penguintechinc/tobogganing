...
def module() -> ModuleContract:
    ...
    return ModuleContract(
        ...
        flags=[
            "tobogganing.perftest.client.schedules",
            "tobogganing.perftest.client.config",
            "tobogganing.perftest.client.version",
        ],
        entitlements=[
            Entitlement("perftest.client.schedules", "community"),
            Entitlement("perftest.client.config", "community"),
            Entitlement("perftest.client.version", "community"),
        ],
        migrations=["0013"],
        health=None,
    )
