...
from hub_api.modules.waddleperf_cluster.api import blueprints
...
def module() -> ModuleContract:
    ...
    register_job_handler(
        "waddleperf_cluster",
        "alert_sweep",
        "hub_api.modules.waddleperf_cluster.worker.tasks.alert_sweep",
    )
    ...
    register_job_handler(
        "waddleperf_cluster",
        "autoperf_cycle",
        "hub_api.modules.waddleperf_cluster.worker.tasks.autoperf_cycle",
    )
