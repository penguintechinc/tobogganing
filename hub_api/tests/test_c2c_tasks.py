...
from hub_api.modules.waddleperf_c2c.worker.tasks import (
...
class TestCeleryTaskStructure:
    ...
    def test_import_celery_app_without_broker(self) -> None:
        ...
        from hub_api.modules.waddleperf_c2c.worker import celery_app
    ...
    def test_import_tasks_without_broker(self) -> None:
        ...
        from hub_api.modules.waddleperf_c2c.worker import tasks
    ...
    def test_run_pair_has_delay_method(self) -> None:
        ...
        from hub_api.modules.waddleperf_c2c.worker.tasks import run_pair
    ...
    def test_run_pair_with_broker_env(self) -> None:
        ...
        from hub_api.modules.waddleperf_c2c.worker.celery_app import celery_app
...
class TestDefaultEngineFactory:
    ...
    def test_create_engine_client_from_endpoint(self) -> None:
        ...
        from hub_api.modules.waddleperf_cluster.services.engine_client import EngineClient
